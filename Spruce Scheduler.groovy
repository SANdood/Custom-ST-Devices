...
//start water program
def cycleOn(){       
    // unschedule(cycleOn)			// don't need this (very expensive) - we are using runIn which is like runOnce
    unsubscribe()    
...
def writeCycles(){
    ...
    // unschedule(writeCycles)		// don't need to do this - high overhead - switched to using runIn() which implies runOnce
}
