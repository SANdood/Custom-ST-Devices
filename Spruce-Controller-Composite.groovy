 ...
 * add device health every 2 hours- zigbeeonoff
 * lns 711,718 DNI to Integer - fix zone 9 bug
 */

metadata {
	definition (name: 'Spruce Controller Composite', namespace: 'plaidsystems', author: 'Plaid Systems') {
		capability 'Switch'
